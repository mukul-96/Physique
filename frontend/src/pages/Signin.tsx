...
export const Signin = () => {
  return (
    <div className="bg-login-bg h-screen w-full flex justify-center items-center ">
      <div className="h-[600px]  w-full max-w-[1350px] rounded-2xl grid grid-cols-1 xl:grid-cols-[60%_40%] md:grid-cols-[50%_50%]">
        ...
        <div className=" bg-athlete2 ml-[150px] mt-[100px] z-30 absolute h-[670px] bg-contain w-[900px]  bg-center bg-no-repeat">
          </div>
