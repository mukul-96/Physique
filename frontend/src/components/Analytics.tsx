...
export default function Analytics({ branchId, month, year, totalExpense }: AnalyticsProps) {
    ...
    // Filter users for the current and previous year's selected month
    ...
    // Monthly and yearly turnover comparison
    ...
    return (
        <div className="p-6 bg-white shadow-lg rounded-lg">
            <div className="flex justify-center items-center mb-6 bg-purple-100">
                <div className="flex flex-col items-center mx-20">
                    <h3 className="text-xl font-semibold">Monthly Turnover</h3>
                    <p className="text-2xl font-bold text-black">
                        ${monthlyTurnoverCurrentYear}
                    </p>
