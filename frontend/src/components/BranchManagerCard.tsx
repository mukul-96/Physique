  ...
  return (
    <div className="card ml-28">
      ...
      <div className="state state--default">
        ...
        <p>
          {Array.from("SendMessage").map((char, index) => (
      ...
      <div className="state state--sent">
        ...
        <p>
          {Array.from("Sent").map((char, index) => (
