...
export default function Plans({ plans }: PlansProps) {
    ...
    const plansToShow = window.innerWidth < 768 ? 1 : 3; // Show 1 on small screens, 3 on large
    const totalSlides = Math.ceil(plans.length / plansToShow); // Calculate total slides
